...
<div class="card mt-5">
    ...
    <div class="card-body">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <a class="btn btn-primary btn-sm" href="<?php echo e(route('kontak.index')); ?>"><i class="fa fa-arrow-left"></i> Back</a>
        </div>
...
<?php echo $__env->make('kontak.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\kevir\Desktop\coba laravel\m4basdat\resources\views/kontak/create.blade.php ENDPATH**/ ?>